...
interface Dot extends MousePosition {
  render: (ctx: CanvasRenderingContext2D, mouse: MousePosition, params: CanvasParams) => void
}
  ...
  useEffect(() => {
    ...
    const animate = () => {
      ...
      dotsRef.current.forEach((dot) => {
        if (dot && typeof dot.render === 'function') {
          dot.render(ctx, mouse, params)
        }
      })
